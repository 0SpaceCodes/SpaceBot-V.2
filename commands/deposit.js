...
module.exports.run = async (bot, message, args) => {
  ...
  .setColor("#FFFFFF")
  .setDescription(`<:crossx:723585712724639856> You can't deposit negative money`);
  ...
  let embed5 = new Discord.MessageEmbed()
  .setColor("#FFFFFF")
  .setDescription(`<:Checkmark:723584979090669679> You have deposited ${args[0]} coins into your bank`);
