...
module.exports.run = async (bot, message, args) => {
    ...
    .setColor("#FFFFFF")
    .setDescription(`<:crossx:723585712724639856> You need 2000 coins to purchase Bronze VIP`);
    ...
    if (args[0] == 'bronze') {
        ...
        let Embed2 = new Discord.MessageEmbed()
        .setColor("#FFFFFF")
        .setDescription(`:no_entry_sign: You need 600 coins to purchase some Nikes`);
        ...
        let Embed2 = new Discord.MessageEmbed()
        .setColor("#FFFFFF")
        .setDescription(`:no_entry_sign: You need 800 coins to purchase a new car`);
        ...
        let Embed2 = new Discord.MessageEmbed()
        .setColor("#FFFFFF")
        .setDescription(`:no_entry_sign: You need 1200 coins to purchase a Mansion`);
        ...
        let embed3 = new Discord.MessageEmbed()
        .setColor("#FFFFFF")
        .setDescription(':no_entry_sign: Enter an item to buy')
        message.channel.send(embed3)
    }
