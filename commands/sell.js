...
//start
    if(args[0] == 'nikes') {
        ...
        .setColor("#FFFFFF")
        .setDescription(`<:crossx:723585712724639856> You don't have Nikes to sell`);
        ...
        .setColor("#FFFFFF")
        .setDescription(`<:Checkmark:723584979090669679> Sold Fresh Nikes For 600 Coins`);
...
//start 
        ...
        let Embed2 = new Discord.MessageEmbed()
        .setColor("#FFFFFF")
        .setDescription(`<:crossx:723585712724639856> You don't have a Car to sell`);
       ...
       let cars = await db.fetch(`car_${message.guild.id}_${user.id}`)
        ...
        let Embed3 = new Discord.MessageEmbed()
        .setColor("#FFFFFF")
        .setDescription(`<:Checkmark:723584979090669679> Sold a Car For 800 Coins`);
...
//start
        ...
        let Embed2 = new Discord.MessageEmbed()
        .setColor("#FFFFFF")
        .setDescription(`<:crossx:723585712724639856> You don't have a Mansion to sell`);
        ...
        let Embed3 = new Discord.MessageEmbed()
        .setColor("#FFFFFF")
        .setDescription(`<:Checkmark:723584979090669679> Sold a Mansion For 1200 Coins`);
